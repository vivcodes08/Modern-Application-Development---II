export default{
  ...
  <div class="flex h-auto w-9/12 flex-col p-2 bg-slate-100">
    <div class="flex justify-center mb-6 mt-2 font-bold text-2xl text-red-600"><span >Create the Song</span></div>
    <form @submit.prevent="handleSubmit">
      ...
      <div class="mb-4">
        ...
        <input name="songName" required value="" class="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none" id="username" type="text" placeholder="Song Name" />
      </div>
      <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <input name="genere" required value="" placeholder="eg. sad#motivational#soft#unplugged" class="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none" id="username" type="text" placeholder="Genere" />
      </div>
      <div class="mb-4">
      ...
      <select placeholder="Choose a Album" class="w-96 p-1 rounded-sm px-5 shadow-sm text-grey outline-none " v-on:change="handleDropDown" v-model="dropDownValue">
    ...
    <input name="durations" required value="" class="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none" id="username" type="text" placeholder="Duration" />
  </div>
      </div>
      <div class=" h-96">
        <label class="mb-2 block text-sm font-bold text-gray-700" for="username"> Lyrics<span class="text-rose-600">*</span> </label>
       <textarea id="editor" class="h-60 overflow-y-auto" name="lyrics"></textarea>
      </div>
      <div class="btn flex justify-center mt-2">
      <button v-if="isVisible" name='submitbtn'  type="submit" class="p-2 bg-cyan-500 text-white font-bold rounded-sm">Produce the Song</button>
      </div>
